...
int main(int argc, char* argv[]) {
    ...
    // std::string plaintext = "Hello World!", recovered;
    // std::string plaintext = "AES is the block cipher standard.", recovered;
...
*/
    ...
    SecByteBlock key(CryptoPP::AES::BLOCKSIZE);
    key[0] = 'A';
    key[1] = 'E';
    key[2] = 'S';
    key[3] = ' ';
    ...
    key[14] = '1';
    key[15] = '6';
    string ciphertext1 = "3eb014eb027a97dd37d62e76e9aa93aa5fd20218fd2f5a2e3a6ab30f82669572";
    string ciphertext2 = "b2ba8d9bef06d9de06af5536296d361072095a04e4d4eefab3c9f9d30028278a";
    string ciphertext3 = "f5a33af09eba924860797f44eaf6ada18c72794ad2060a82231276c04d90d316";


    for (int i=0 ; i<CryptoPP::AES::BLOCKSIZE ; i++) iv[i] = '0';

    // CryptoPP::AlgorithmParameters params = CryptoPP::MakeParameters(CryptoPP::Name::FeedbackSize(), 2 /*8-bits*/)
...
/*   // CFB_decryption_ciphertext3 with iv = 0, byte = 2
	CFB_Mode< AES >::Decryption dec;
    dec.SetKey( key, CryptoPP::AES::DEFAULT_KEYLENGTH, params );
 
    // The StreamTransformationFilter removes
    //  padding as required.
    StringSource ss2( ciphertext3, true,
    new HexDecoder(
        new StringSink( encoded )
    ) // HexEncoder
	); // StringSource
    StringSource ss3( encoded, true, 
...
*/
/*
 // CBC_decryption_ciphertext2 with iv = 0
	CBC_Mode< AES >::Decryption d;
    d.SetKeyWithIV( key, CryptoPP::AES::DEFAULT_KEYLENGTH, iv );

    // The StreamTransformationFilter removes
    //  padding as required.
    StringSource ss2( ciphertext2, true,
    new HexDecoder(
        new StringSink( encoded )
    ) // HexEncoder
	); // StringSource
...
*/
 ...
 // ECB_decryption_ciphertext1
    ...
    // The StreamTransformationFilter removes
    //  padding as required.
    StringSource ss2( ciphertext1, true,
    new HexDecoder(
        new StringSink( encoded )
    ) // HexEncoder
	); // StringSource
